...
// Function to add event listener to the hide button
...
function addHideButtonListenerA() {
...
function addHideButtonListenerB() {
    const hideButton = document.getElementById("hidson");
...
const observer = new MutationObserver((mutationsList, observer) => {
    for (const mutation of mutationsList) {
        ...
        if (mutation.type === 'childList') {
            ...
            if (document.getElementById("hidson")){
                addHideButtonListenerB();
            }
        }
    }
});
...
document.addEventListener('DOMContentLoaded',async function (){
    ...
    const redirectUri = `${stringurl}callback`;
    //const scopes = 'playlist-read-private playlist-modify-public playlist-modify-private user-read-email user-read-private user-top-read playlist-read-private';
    const scopes = 'playlist-read-private user-read-email user-read-private user-top-read playlist-read-private';
          ...
          // Select the div to display user info
            ...
            userInfoDiv.innerHTML = `
                ...
                <div id="timeRangeButtons">
                    <button id="shortTermButton">Last 4 Weeks</button>
                    <button id="mediumTermButton">Last 6 Months</button>
                    <button id="longTermButton">All Time</button>
                </div>
                <div id="statos"></div>
                
            `;
             // Add event listeners to buttons that change the timeRange and call getThings()
             document.getElementById('shortTermButton').addEventListener('click', () => {
                timeRange = 'short_term';
                getThings(accessToken);  // Call the function after updating timeRange
            });

            document.getElementById('mediumTermButton').addEventListener('click', () => {
                timeRange = 'medium_term';
                getThings(accessToken);  // Call the function after updating timeRange
            });

            document.getElementById('longTermButton').addEventListener('click', () => {
                timeRange = 'long_term';
                getThings(accessToken);  // Call the function after updating timeRange
            });
            ...
            .then(artistData => {
               ...
               // console.log('Most listened artist:', artistData.items);
                ...
                let genreCount = {}; // Store genres and their count
                ...
                const genres = Object.keys(genreCount); // Genre names
                const genreValues = Object.values(genreCount); // Count of genres
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            backgroundColor: [
                                ...
                                '#FF6347', '#ADFF2F', '#7FFFD4', '#20B2AA', '#87CEEB', '#9370DB'
                            ]
                        }]
                    },
                    options: {
                        ...
                        title: {
                            display: true,
                            text: 'Genres You Listen To'
                        }
                    }
                }); */
                let genreCount = {}; // Store genres and their count

                // Loop through each artist and count their genres
                artistData.items.forEach(artist => {
                    artist.genres.forEach(genre => {
                        if (genreCount[genre]) {
                            genreCount[genre]++;
               ...
               // console.log('Genres and their artist counts:');
                ...
                const hamid = document.createElement('h2');
                ...
                <div class="songo">
                    <a href="${artistData.items[0].external_urls.spotify}" target="_blank">
                        <img width="150" height="150" src="${artistImageUrl0}" alt="Artist Image" />
                    </a>
                ...
                <div class="songo">
                    <a href="${artistData.items[1].external_urls.spotify}" target="_blank">
                        <img width="150" height="150" src="${artistImageUrl1}" alt="Artist Image" />
                    </a>
                ...
                <div class="songo">
                    <a href="${artistData.items[2].external_urls.spotify}" target="_blank">
                        <img width="150" height="150" src="${artistImageUrl2}" alt="Artist Image" />
                    </a>
                ...
                trackInfo.innerHTML = `
                        <div class="songo">
                            <a href="${trackData.items[0].external_urls.spotify}" target="_blank">
                                <img width="150" height="150" src="${albumCoverUrl0}" alt="Album Cover" />
                            </a>
                        ...
                        <div class="songo">
                            <a href="${trackData.items[1].external_urls.spotify}" target="_blank">
                                <img width="150" height="150" src="${albumCoverUrl1}" alt="Album Cover" />
                            </a>
                        ...
                        <div class="songo">
                            <a href="${trackData.items[2].external_urls.spotify}" target="_blank">
                                <img width="150" height="150" src="${albumCoverUrl2}" alt="Album Cover" />
                            </a>
                            <p>${trackData.items[2].name} by <strong>${trackData.items[2].artists[0].name}</strong></p>
                        </div>
                        
                        <button id="showmoresong"> Show more</button>
            ...
            .then(playlistData => {
                ...
                const issa = document.createElement('h2');
                ...
                playlistInfo.innerHTML = `
                    <div class="songo">
                        <a href="${playlistData.items[0].external_urls.spotify}" target="_blank">
                            <img width="150" height="150" src="${playlistCoverUrl0}" alt="Playlist Cover" />
                        </a>
                    ...
                    <div class="songo">
                        <a href="${playlistData.items[1].external_urls.spotify}" target="_blank">
                            <img width="150" height="150" src="${playlistCoverUrl1}" alt="Playlist Cover" />
                        </a>
                    ...
                    <div class="songo">
                        <a href="${playlistData.items[2].external_urls.spotify}" target="_blank">
                            <img width="150" height="150" src="${playlistCoverUrl2}" alt="Playlist Cover" />
                        </a>
